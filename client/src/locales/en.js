export default {
  ...
  restocking: {
    title: 'Restocking',
    description: 'Set a budget and restock items that are below their reorder point',
    budget: 'Restocking Budget',
    ...
    noItems: 'No items need restocking at this time',
